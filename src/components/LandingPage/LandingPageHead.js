...
return (
    ...
    //             </div>
    //             <div className="col-md-5 col-lg-6 pt-3 pt-md-0 d-flex flex-column justify-content-center">
    //                 <h2 className="display-4 intro-name text-center text-md-start pb-1 pb-md-4">Izabela Kowalska</h2>
    //                 <h3 className="intro-desc text-center text-md-start">Mediacje</h3>
    //                 <h3 className="intro-desc text-center text-md-start">Negocjacje</h3>
    //                 <h3 className="intro-desc text-center text-md-start">Rozwiązywanie sporów</h3>
    //             </div>
    //         </div>
    //     </div>
    // </section>
